...
import ReactRow from '../../baseComponents/reactRow';
...
class SignIn extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
            <TatvamCol s={12} m={6} l={8} xl={11} className="mb-2 pl-4 offset-xl1">
                <img src={brantLogo} />
               
            </TatvamCol>
            <TatvamCol s={12} m={6} l={8} xl={11}>
                <form name="form" onSubmit={this.handleSubmit}>                             
                    ...
                    {submitted && !username &&
                            <div className="helper-text wrong">Username is required</div>
                        }
                    ...
                    {submitted && !password &&
                            <div className="helper-text wrong">Password is required</div>
                        }
                    </Row> 
                   ...
                   { this.props.errorMessage.message && <div className="form-group">
